...
public class Lv3Invis : ActionScript
{
    ...
    {
        //MAKES THE THING TELEPORT BEHIND THE PLAYER//
    ...
    void TeleportBehindPlayer()
    {
        ...
        //IF DISTANCE IS LESS THAN CONDITION AND IF DOESN'T HAVE TRAIT//
        ...
        //IF THE THING HAS THE INVISIBILITY TRAIT AND DOESN'T HAVE THE AURA//
    ...
    IEnumerator PrepareToAttack()
    {
        ...
        //SPAWNS THE AURA AT THE THING'S LOCATION//
    ...
    void DealDamage(float amount)
    {
        if (!DeliverFatalBlow)
        {
            ...
            if (Player == null) return; // extra safety
