...
public class Level_AdamD : LevelBuilder
{
    public Level_AdamD()
    {
    ...
    {
        //base.Customize();        //If we haven't created a player yet for this playthrough, make one.
        SpawnPlayer();
        ...
        LinkOdds = 1;// odds of making a path between an adjacent grid, between 0-1.
        ...
        //make a weapon spawn in the room instead of a boss.
    }
    public override void BuildGeoMap() //if you're building a custom room shape, building main path will toss an error, so override it
    {
        //base.BuildGeoMap();        //Two nested for loops lets us build a grid of room slots at our desired size
